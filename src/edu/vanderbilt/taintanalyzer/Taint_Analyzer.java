...
public class Taint_Analyzer {
	...
	public static void main(String[] args) throws Exception
	{
		...
		Option Instrumented_JRE = new Option("I0", "Instrumented_JRE", true, "Path To Instrumented JRE Creted By Phosphor");
        ...
        String classPath_val = new String(ReferenceJars_val + File.pathSeparator + HelperJars_val + File.pathSeparator + Phosphor_Jar_val);
		try {
		ZipFileProcessor Z1 = new ZipFileProcessor(Instrumented_JRE_val, Phosphor_Jar_val, SourceZipFile_val, MainCLassFle_val, MainClassArgs_val, classPath_val, JRE_Args_val );
		} catch (Exception E)
		{
			E.printStackTrace();
		}
