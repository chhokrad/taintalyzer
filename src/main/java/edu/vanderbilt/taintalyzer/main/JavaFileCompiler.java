...
public class JavaFileCompiler {
	...
	public static void compile(ArrayList<File> files, String Classpath, String OutputDir, ArrayList<File> files_,
			String JreArgs_val) throws Exception {

		/*
		 * files.add(new File("." + File.separator + "src" + File.separator +
		 * "TaintEntry.java")); files.add(new File("." + File.separator + "src" +
		 * File.separator + "TaintSerializer.java")); files.add(new File("." +
		 * File.separator + "src" + File.separator + "JsonCreator.java"));
		 */
